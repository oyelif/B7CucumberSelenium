...
public class Login_StepDefs {
    ...
    public void the_user_enters_teacher_credentials() {
       // System.out.println("I enter teacher username and password than click log in button");
        loginPage.login();
    ...
    public void the_user_enters_student_credentials() {
        //System.out.println("I enter student username and password than click log in button");
        loginPage.loginAsDeveloper();
    }

    @When("The user enters developer credentials")
    public void the_user_enters_developer_credentials() {
        //System.out.println("I enter developer username and password than click log in button");
        loginPage.loginAsDeveloper();
    }

   // @When("The user enters SDET credentials")
   // public void the_user_enters_sdet_credentials() {
   //     System.out.println("I enter SDET username and password than click log in button");
   // }
